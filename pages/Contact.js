...
const Contact = () => {
    return (
      <div className="flex flex-col justify-center items-center h-screen">
        <h1 className="mb-3 lg:mb-10 md:mb-5 uppercase tracking-[20px] text-white text-2xl z-10">
            Contáctame
        </h1>
          <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-5 place-content-center">
            ...
            <div className="bg-gray-700 w-full h-44 lg:w-96 lg:h-52 bg-opacity-50 border-solid rounded-xl p-5 flex flex-col">
                ...
                <button className="place-self-center mt-2 inline-flex items-center justify-center bg-gray-900 rounded-lg ring-offset-0 ring-2 ring-sky-500 p-3">
                    <a className="text-white font-semibold" href="/files/Curriculum-NicolásLuzaPino.pdf" target="_blank" >Visualizar</a>
